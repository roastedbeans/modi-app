...
def gsm_band_name(arfcn):
    """Get GSM band name from ARFCN"""
    if arfcn >= 1 and arfcn <= 124:
        return 'GSM900'
    elif arfcn >= 128 and arfcn <= 251:
        return 'GSM850'
    elif arfcn >= 259 and arfcn <= 293:
        return 'GSM450'
    elif arfcn >= 306 and arfcn <= 340:
        return 'GSM480'
    elif arfcn >= 350 and arfcn <= 425:
        return 'GSM750'
    elif arfcn >= 438 and arfcn <= 511:
        return 'GSM800'
    elif arfcn >= 512 and arfcn <= 885:
        return 'DCS1800'
    elif arfcn >= 955 and arfcn <= 1023:
        return 'GSM900E'
    else:
        return 'Unknown'

def lte_band_name(earfcn):
    """Get LTE band name from EARFCN"""
    # Simplified LTE band mapping
    if earfcn >= 0 and earfcn <= 599:
        return 'Band 1 (2100MHz)'
    elif earfcn >= 600 and earfcn <= 1199:
        return 'Band 2 (1900MHz)'
    elif earfcn >= 1200 and earfcn <= 1949:
        return 'Band 3 (1800MHz)'
    elif earfcn >= 1950 and earfcn <= 2399:
        return 'Band 4 (1700MHz)'
    elif earfcn >= 2400 and earfcn <= 2649:
        return 'Band 5 (850MHz)'
    elif earfcn >= 2650 and earfcn <= 2749:
        return 'Band 6 (800MHz)'
    elif earfcn >= 2750 and earfcn <= 3449:
        return 'Band 7 (2600MHz)'
    elif earfcn >= 3450 and earfcn <= 3799:
        return 'Band 8 (900MHz)'
    elif earfcn >= 3800 and earfcn <= 4149:
        return 'Band 9 (1800MHz)'
    elif earfcn >= 4150 and earfcn <= 4749:
        return 'Band 10 (1700MHz)'
    elif earfcn >= 4750 and earfcn <= 4949:
        return 'Band 11 (1500MHz)'
    elif earfcn >= 5010 and earfcn <= 5179:
        return 'Band 12 (700MHz)'
    elif earfcn >= 5180 and earfcn <= 5279:
        return 'Band 13 (700MHz)'
    elif earfcn >= 5280 and earfcn <= 5379:
        return 'Band 14 (700MHz)'
    elif earfcn >= 5730 and earfcn <= 5849:
        return 'Band 17 (700MHz)'
    elif earfcn >= 5850 and earfcn <= 5999:
        return 'Band 18 (850MHz)'
    elif earfcn >= 6000 and earfcn <= 6149:
        return 'Band 19 (850MHz)'
    elif earfcn >= 6150 and earfcn <= 6449:
        return 'Band 20 (800MHz)'
    elif earfcn >= 6450 and earfcn <= 6599:
        return 'Band 21 (1500MHz)'
    elif earfcn >= 36000 and earfcn <= 36199:
        return 'Band 33 (1900MHz TDD)'
    elif earfcn >= 36200 and earfcn <= 36349:
        return 'Band 34 (2000MHz TDD)'
    elif earfcn >= 36350 and earfcn <= 36949:
        return 'Band 35 (1900MHz TDD)'
    elif earfcn >= 36950 and earfcn <= 37549:
        return 'Band 36 (1900MHz TDD)'
    elif earfcn >= 37550 and earfcn <= 37749:
        return 'Band 37 (1900MHz TDD)'
    elif earfcn >= 37750 and earfcn <= 38249:
        return 'Band 38 (2600MHz TDD)'
    elif earfcn >= 38250 and earfcn <= 38649:
        return 'Band 39 (1900MHz TDD)'
    elif earfcn >= 38650 and earfcn <= 39649:
        return 'Band 40 (2300MHz TDD)'
    elif earfcn >= 39650 and earfcn <= 41589:
        return 'Band 41 (2500MHz TDD)'
    elif earfcn >= 41590 and earfcn <= 43589:
        return 'Band 42 (3500MHz TDD)'
    elif earfcn >= 43590 and earfcn <= 45589:
        return 'Band 43 (3700MHz TDD)'
    else:
        return f'Unknown Band (EARFCN {earfcn})'

def wcdma_band_name(uarfcn):
    """Get WCDMA band name from UARFCN"""
    if uarfcn >= 10562 and uarfcn <= 10838:
        return 'Band I (2100MHz)'
    elif uarfcn >= 9662 and uarfcn <= 9938:
        return 'Band II (1900MHz)'
    elif uarfcn >= 1162 and uarfcn <= 1513:
        return 'Band III (1800MHz)'
    elif uarfcn >= 1537 and uarfcn <= 1738:
        return 'Band IV (1700MHz)'
    elif uarfcn >= 4357 and uarfcn <= 4458:
        return 'Band V (850MHz)'
    elif uarfcn >= 4387 and uarfcn <= 4413:
        return 'Band VI (800MHz)'
    elif uarfcn >= 2237 and uarfcn <= 2563:
        return 'Band VII (2600MHz)'
    elif uarfcn >= 2937 and uarfcn <= 3088:
        return 'Band VIII (900MHz)'
    elif uarfcn >= 9237 and uarfcn <= 9387:
        return 'Band IX (1700MHz)'
    elif uarfcn >= 3112 and uarfcn <= 3388:
        return 'Band X (1700MHz)'
    elif uarfcn >= 3712 and uarfcn <= 3787:
        return 'Band XI (1500MHz)'
    elif uarfcn >= 3842 and uarfcn <= 3903:
        return 'Band XII (700MHz)'
    elif uarfcn >= 4017 and uarfcn <= 4043:
        return 'Band XIII (700MHz)'
    elif uarfcn >= 4117 and uarfcn <= 4143:
        return 'Band XIV (700MHz)'
    else:
        return f'Unknown Band (UARFCN {uarfcn})'
