...
from qualcomm import diagcmd
from qualcomm.diaggsmlogparser import DiagGsmLogParser
from qualcomm.diagwcdmalogparser import DiagWcdmaLogParser
from qualcomm.diagumtslogparser import DiagUmtsLogParser
from qualcomm.diagltelogparser import DiagLteLogParser
from qualcomm.diag1xlogparser import Diag1xLogParser
from qualcomm.diagnrlogparser import DiagNrLogParser

from qualcomm.diagcommoneventparser import DiagCommonEventParser
from qualcomm.diaglteeventparser import DiagLteEventParser
from qualcomm.diaggsmeventparser import DiagGsmEventParser
from qualcomm.diagfallbackeventparser import DiagFallbackEventParser
...
class QualcommParser:
    ...
    def parse_diag_log(self, pkt, args=None):
        ...
        if len(pkt_body) != (pkt_header.length2 - 12):
            self.logger.log(logging.DEBUG, "Packet length mismatch: expected {}, got {}".format(pkt_header.length2, len(pkt_body)+12))
